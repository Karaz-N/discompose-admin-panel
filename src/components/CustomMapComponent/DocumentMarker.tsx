...
export default function DocumentMarker() {
	...
	const selectedPrintFilter = useDocumentStore(
		(state) => state.selectedPrintFilter,
	);

	const selectedImageFilter = useDocumentStore(
		(state) => state.selectedImageFilter,
	);
	...
	return (
		<>
			...
			{selectedManuscriptFilter &&
				filteredManuscript.map((manuscript) => {
						...
						return (
							<>
								...
								<CustomMarker
									...
									position={[
										manuscript.from.latitude,
										manuscript.from.longitude,
									]}
						...
						<>
							...
							<CustomMarker
								...
								onClick={() => {
									setSidebarVisible(true);
									setSidebarOpen(true);
									setFilterFromMap(print.place.latitude, print.place.longitude);
								}}
							/>
						</>
					) : null,
						...
						<>
							...
							<CustomMarker
								...
								onClick={() => {
									setSidebarVisible(true);
									setSidebarOpen(true);
									setFilterFromMap(image.place.latitude, image.place.longitude);
								}}
							/>
						</>
					) : null,
